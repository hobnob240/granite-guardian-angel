  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Stonework Services — Mannock Granite" },
      {
        ...
        content:
          "Worktops, vanities, splashbacks, commercial, bespoke, fabrication, templating and installation.",
      },
...
const services: Service[] = [
  {
    ...
    blurb:
      "Islands, runs and breakfast bars in granite, quartz, marble and porcelain — templated, fabricated and installed to a finish you'll never want to cover.",
    benefits: [
      "Mitred 40mm waterfall edges",
      "Integrated drainage grooves",
      "Undermount and integrated sink cut-outs",
    ],
    img: projectKitchen,
  },
  {
    ...
    blurb:
      "Vanities, dressing tables and shower trays in matching stone for a single, considered material story.",
    benefits: [
      "Bookmatched veining",
      "Tap and basin precision cut-outs",
      "Honed or polished finishes",
    ],
    img: projectBath,
  },
  {
    title: "Splashbacks",
    blurb:
      "Continuous splashbacks and full-height feature walls in the same slab as your worktop — no grout, no joins, no compromise.",
    benefits: [
      "Single-slab fabrication",
      "Behind-hob or whole-wall coverage",
      "Heat-tolerant material guidance",
    ],
    img: projectKitchen2,
  },
  {
    ...
    blurb:
      "Bars, reception counters, hospitality suites and high-traffic environments delivered to programme.",
    benefits: [
      "Phased install for trading sites",
      "M&E coordination with main contractor",
      "Volume slab sourcing",
    ],
  ...
  },
  {
    ...
    blurb:
      "Fireplaces, dining tables, shelving, sculptural pieces — anything that can be drawn can be cut.",
  ...
  },
  {
    title: "Fabrication",
    blurb:
      "Our workshop runs five-axis CNC alongside hand-finishing benches — for tolerances measured in fractions of a millimetre.",
  ...
  },
  {
    ...
    blurb:
      "Laser-precise digital templates capture every wall, return and out-of-square — eliminating site surprises.",
    benefits: [
      "Sub-millimetre accuracy",
      "Same-week scheduling",
      "Coordination with kitchen fitters",
    ],
    img: projectBath2,
  },
  {
    title: "Installation",
    blurb:
      "Two-mason teams arrive with everything they need. Worktops in by lunch, sinks plumbed, kitchen left immaculate.",
    benefits: [
      "Same-day installation",
      "Cabinet protection during fit",
      "Silicone finishing to standard",
    ],
    img: projectKitchen,
  },
];
...
function ServiceRow({
  ...
  return (
    <Reveal>
      <article
        className={`group relative grid md:grid-cols-2 gap-0 border border-white/10 bg-surface/30 overflow-hidden transition-colors hover:bg-surface/60`}
      >
        <div
          className={`relative overflow-hidden aspect-[4/3] md:aspect-auto ${reverse ? "md:order-2" : ""}`}
        >
          <img
            src={s.img}
            alt={s.title}
